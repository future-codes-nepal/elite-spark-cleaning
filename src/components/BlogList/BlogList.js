              ...
              {blogs.map((blog, bitem) => (
                <div className={`post  ${blog.blClass}`} key={bitem}>
                  ...
                  <div className="entry-details">
                    ...
                    <p>
                      {" "}
                      Elite Spark shares expert advice on maintaining homes and
                      offices across New Zealand. From eco-friendly products to
                      modern cleaning techniques, we help you achieve a
